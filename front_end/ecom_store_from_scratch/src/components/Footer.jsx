      ...
      <div className="container">
        ...
        <div className="p-t-40">
          <div className="flex-c-m flex-w p-b-18">
            <a href="footer.html" className="m-all-1">
              <img src="images/icons/icon-pay-01.png" alt="ICON-PAY"></img>
            </a>

            <a href="footer.html" className="m-all-1">
              <img src="images/icons/icon-pay-02.png" alt="ICON-PAY"></img>
            </a>
            ...
            <a href="footer.html" className="m-all-1">
              <img src="images/icons/icon-pay-04.png" alt="ICON-PAY"></img>
            </a>

            <a href="footer.html" className="m-all-1">
              <img src="images/icons/icon-pay-05.png" alt="ICON-PAY"></img>
            </a>
          </div>
        </div>
      </div>
